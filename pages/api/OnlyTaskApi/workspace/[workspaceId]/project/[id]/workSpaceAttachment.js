...
import { decrypt } from "../../../../../../../utils/encrpt_decrpt_function";
...
export default async function handler(req, res) {
  ...
  const s3Config = clientCredential
    ? {
        ...
        credentials: {
          accessKeyId: decrypt(clientCredential.accessKeyId),
          secretAccessKey: decrypt(clientCredential.secretAccessKeyId),
        },
      }
    : {
